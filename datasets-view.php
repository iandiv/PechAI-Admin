            ...
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content round_md border-0 shadow-lg">
                    ...
                    <div class="modal-footer border-0 ">
                        ...
                        <button class="btn text-primary fw-bold round" type="submit" name="upload">
                            Upload</button>
                    </div>
                </div>
                        ...
                        <form method="post">
                                ...
                                <div class="ms-1 ">
                                    ...
                                    if ($rowCount > 0) {
                                        while ($rows = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            // Check if classname contains "con" or starts with "con"
                                            $borderClass = (strpos($rows['ds_img'], 'con') !== false || strpos($rows['ds_img'], 'con') === 0) ? 'border-warning' : 'border-white';

                                            ?>
                                            <div class="image-container mb-1 round border <?php echo $borderClass; ?> border-3">
                                                <img loading="lazy" decoding="async" id="img-<?php echo $rows['ds_id'] ?>"
                                                    onclick="getID('<?php echo $rows['ds_id'] ?>')"
                                                    class=" p-0  img-thumbnail round   "
                            ...
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <button type="button" class="ms-sm-3 loadmore btn bg-primary text-white">Load
                                        More</button>
